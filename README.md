...
Post-replication mechanism results now sharpen that question:
...
- **E036 canonical likelihood:** scoring every closed-vocabulary plan by one canonical continuation did not clear the preregistered predicate-plus-uniform floor: 0/64 exact unrotated and 10/64 after cyclic rotation versus 12.32/64 expected under uniform choice over binding plans. The assisted E036 arm is stopped.
...
- **E043 cross-file retrieval:** at the fixed 32-candidate budget, Potion 16M recovered 192/265 targets (72.45%) and failed its 75% recall gate; CodeRank recovered 224/265 (84.53%) and passed.
- **E045 retrieved reranking:** the unchanged E031 PairwiseMLP produced 123/265 top-1 after CodeRank top-32 retrieval versus 122/265 for CodeRank rank-1, +0.38 pp; p = 1.0; clustered 95% CI -8.01 to +8.05 pp. That exact reranking path is stopped. E046 tests a label-free deterministic import-dependency priority before CodeRank ranking.
